#region New-BluGenieUID (Function)
    function New-BluGenieUID
    {
    <#
        .SYNOPSIS
            Create a New UID
    ...
    #>
        ...
        #region Nested Functions
            #region Get Random Num with Place Holder
                Function GetRandomWithPlaceHolder
                {
                    Param
                    (
                        [Parameter(Position = 0)]
                    ...
                    )
                    {
                        1
                        {
                            Return $(Get-Random -Minimum 1 -Maximum 9).ToString('#')
                        }
                        2
                        {
                            Return $(Get-Random -Minimum 1 -Maximum 99).ToString('0#')
                        }
                        3
                        {
                            Return $(Get-Random -Minimum 1 -Maximum 999).ToString('00#')
                        }
                        4
                        {
                            Return $(Get-Random -Minimum 1 -Maximum 9999).ToString('000#')
                        }
                        5
                        {
                            Return $(Get-Random -Minimum 1 -Maximum 99999).ToString('0000#')
                        }
                    }
                }
            #endregion
        ...
        #region Build Sets
            ...
            )
            {
                1
                {
                    Return $('{0}' -f $(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet))
                }
                2
                {
                    Return $('{0}{1}{2}' -f $(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet),$Delimiter,$(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet))
                }
                3
                {
                    Return $('{0}{1}{2}{1}{3}' -f $(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet),$Delimiter,$(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet),$(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet))
                }
                4
                {
                    Return $('{0}{1}{2}{1}{3}{1}{4}' -f $(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet),$Delimiter,$(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet),$(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet),$(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet))
                }
                5
                {
                    Return $('{0}{1}{2}{1}{3}{1}{4}{1}{5}' -f $(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet),$Delimiter,$(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet),$(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet),$(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet),$(GetRandomWithPlaceHolder  -CharPerSet $NumPerSet))
                }
            }
        #endregion
    }
#endregion New-BluGenieUID (Function)