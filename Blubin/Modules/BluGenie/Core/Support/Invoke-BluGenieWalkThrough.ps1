...
Function Invoke-BluGenieWalkThrough
{
    <#
    .SYNOPSIS
    ...
    .NOTES
        ...
        * Original Build Version    : 19.02.0505
        * Latest Author             : Michael Arroyo
        * Latest Build Version      : 20.11.1301
        * Comments                  : 
        * Dependencies              : 
                                        ~
        * Build Version Details     : 
            ~ 19.02.0505: • [Michael Arroyo] Posted
            ~ 19.04.0801: • [Michael Arroyo] Updated the error control for the entire process to support External Help (XML) files
            ...
            ~ 19.05.2401: • [Michael Arroyo] Updated syntax based on PSAnalyzer
            ~ 19.10.0801: • [Michael Arroyo] Rebuilt the entire process to an an external (Only) call.
            ...
            ~ 19.10.3001: • [Michael Arroyo] Updated Example Title call to pull the exact match.  Prior, if there was more then 10 examples both 1 and 10 would show when only requesting Example 1.
            ~ 19.11.2001: • [Michael Arroyo] Updated the Parameter Validate Set RegEx Parser to support multiple line scrapping
		          • [Michael Arroyo] Updated the Example Set RegEx Parser to support multiple line scrapping
            ~ 20.11.1301: * [Michael Arroyo] Removed the Alias [Invoke-WalkThrough] and copied this script over to a Function Script called [Invoke-Walkthrough].  Other scripts are looking for a function
