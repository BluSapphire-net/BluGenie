#region New-BluGenieTimeStamp (Function)
    function New-BluGenieTimeStamp
    {
    <#
        .SYNOPSIS
            Return a Time Stamp specifically for log files
        ...
        .EXAMPLE
            ...
            This will return a Time Stamp that is valid for file names
    ...
    #>
        ...
        #region Main
            Return $('{0}_{1}{2}' -f $(Get-Date -f MM.dd.yyyy),$(Get-Date -UFormat %R).Replace(':','.'),$(Get-Date -f .ss))
        #endregion
    }
#endregion New-BluGenieTimeStamp (Function)